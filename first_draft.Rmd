...
### Concerning Expectations (Figures 2 to 7)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;As expected, those who own a home are more favorable of the cost of housing than those who rent, though both groups rate it poorly (Fig. 2).
...
![Fig. 5](GIMP_workspace/GenDemographicsFig5.png)

![Fig. 6](GIMP_workspace/GenDemographicsFig6.png)

![Fig. 7](GIMP_workspace/GenDemographicsFig7.png)

### Renting vs. Owning a Home (Figures 8 to 12)



![Fig. 8](GIMP_workspace/GenDemographicsFig8.png)

![Fig. 9](GIMP_workspace/GenDemographicsFig9.png)

![Fig. 10](GIMP_workspace/GenDemographicsFig10.png)

![Fig. 11](GIMP_workspace/GenDemographicsFig11.png)

![Fig. 12](GIMP_workspace/GenDemographicsFig12.png)
